...
class LocationService:
    ...
    def __init__(self):
        ...
        self.non_location_words = {
            ...
            "فيها", "في", "عايز", "عاوز", "مش", "لا", "لأ",
            "واي", "فاي", "نت", "انترنت", "نت",
            "مفروش", "مفروشة", "furnished", "unfurnished",
            "مكيف", "تكييف", "ac", "wifi",
            "بلكونه", "حمام", "مطبخ", "غساله", "ثلاجه",
            "طلاب", "طلبه", "student", "students",
            "شباب", "بنات", "boys", "girls", "ولاد",
            "ارخص", "اغلى", "رخيص", "غالي", "سعر",
            "cheap", "expensive", "price", "budget",
            "تحت", "فوق", "من", "الى", "لـ", "الي",
        }
